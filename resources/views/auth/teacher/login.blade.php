...
@section('login-form')
    ...
    <form class="form-login" role="form" method="POST" action="{{ url('/teacher/login') }}">
        <h2 style="background-color: #CC6633" class="form-login-heading">TEACHER LOGIN</h2>
        @if (count($errors) > 0)
